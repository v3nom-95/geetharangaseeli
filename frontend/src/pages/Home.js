    ...
    <div>
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black text-white">
        ...
        <div className="absolute inset-0 -z-10 flex flex-wrap items-center justify-center pointer-events-none">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="w-24 h-24 m-8 bg-gradient-to-tr from-white/10 to-white/5 rounded-3xl shadow-2xl animate-float-advanced" style={{ filter: 'drop-shadow(0 8px 24px #fff2)' }}></div>
          ))}
        </div>
        <div 
        ...
        {/* Floating Elements */}
        {/* 3D floating cubes for UI/UX */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-3xl blur-xl opacity-60 animate-float-advanced"></div>
        <div className="absolute top-40 right-20 w-32 h-32 bg-white/10 rounded-3xl blur-xl opacity-40 animate-float-advanced" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-white/10 rounded-3xl blur-xl opacity-50 animate-float-advanced" style={{ animationDelay: '4s' }}></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Hero Content */}
            <div className={`transition-all duration-1000 ${isLoaded ? 'animate-slide-in-left' : 'opacity-0'}`}>
              {/* Removed 'Available for freelance projects' component for theme consistency */}
              
              <h1 className="section-title-advanced leading-tight mb-8 text-white">
                Hi, I'm <span className="relative">
                  <span className="text-gradient">Geetha</span>
                <div className="absolute -bottom-2 left-0 right-0 h-1 bg-white rounded-full transform scale-x-0 animate-[scaleX_1s_ease-out_0.5s_forwards] origin-left"></div>
                </span>
              </h1>
              ...
              <p className="section-subtitle-advanced max-w-xl text-white/70">
              ...
              <div className="grid grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-white font-display">4+</div>
                  <div className="text-sm text-white/60 font-medium">Projects Completed</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-white font-display">4+</div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white font-display">3+</div>
                  <div className="text-sm text-white/60 font-medium">Months Experience</div>
                </div>
              </div>
            </div>
            ...
            <div className={`flex justify-center lg:justify-end transition-all duration-1000 delay-300 ${isLoaded ? 'animate-slide-in-right' : 'opacity-0'}`}>
              <div className="relative group">
                ...
                <div className="absolute -inset-4 bg-white/10 rounded-full blur-xl opacity-30 group-hover:opacity-40 transition-opacity animate-pulse"></div>
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-white/10 rounded-3xl blur-2xl opacity-40 animate-float-advanced"></div>
                <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-white/10 rounded-3xl blur-2xl opacity-40 animate-float-advanced" style={{ animationDelay: '3s' }}></div>
                
                {/* Main Image */}
                <div className="relative z-10">
                  <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-white/20 backdrop-blur-sm bg-black">
                    <img 
                      src="/images/g-3.png" 
                  ...
                  {/* Floating Badge */}
                  <div className="absolute -bottom-4 -right-4 bg-black/80 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border border-pink-500 animate-bounce flex flex-col items-center" style={{ minWidth: '120px' }}>
                    <div className="flex items-center justify-center mb-2">
                      <svg className="w-6 h-6 text-pink-500 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                      </svg>
                      <span className="ml-2 font-bold text-white text-base">Available</span>
                    </div>
                    <div className="text-xs text-white/70 font-medium mb-1">Ready to work</div>
                    <div className="flex items-center gap-1 mt-1">
                      <svg className="w-4 h-4 text-white/60" fill="currentColor" viewBox="0 0 20 20">
                        <circle cx="10" cy="10" r="8" fill="#222" />
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" fill="#fff"/>
                      </svg>
                      <span className="text-xs text-pink-500 font-semibold">Trusted</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="section-advanced bg-black relative z-10" style={{backgroundColor: '#111'}}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-white/10 rounded-full border border-white/30 text-white font-medium mb-8">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd"/>
              </svg>
              What I Do Best
            </div>
            <h2 className="section-title-advanced text-center text-white">
      ...
      <section className="section-advanced bg-black text-white relative overflow-hidden">
        {/* Background Pattern */}
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-500 hover:transform hover:scale-105">
                  ...
                  <div className="text-4xl lg:text-5xl font-bold mb-2 font-display text-white group-hover:text-white transition-colors">
                    {stat.value}
                  </div>
                  <div className="text-white/70 font-semibold text-lg mb-2">{stat.label}</div>
      ...
      <section className="section-advanced bg-gradient-mesh relative overflow-hidden">
        ...
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-white/10 rounded-3xl blur-2xl animate-float-advanced" style={{ animationDelay: '2s' }}></div>
        
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-12 lg:p-16 shadow-2xl border border-white/20">
            <div className="mb-8">
              <div className="inline-flex items-center px-4 py-2 bg-black/80 rounded-full text-white font-medium mb-6 border border-white/20">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <circle cx="10" cy="10" r="8" fill="#222" />
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.293l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z" clipRule="evenodd" fill="#fff"/>
                </svg>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6 font-display">
              Ready to Grow Your
              <br />
              <span className="text-white">Brand's Digital Presence?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link 
                to="/services" 
                className="btn-advanced text-white bg-black/80 border border-white/20 rounded-full px-8 py-4 font-bold inline-flex items-center space-x-2 group hover:bg-black/90 transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link 
                to="/contact" 
                className="btn-secondary-advanced text-white bg-black/80 border border-white/20 rounded-full px-8 py-4 font-bold inline-flex items-center space-x-2 group hover:bg-black/90 transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
