...
function Footer() {
  return (
    <footer className="bg-black text-white relative overflow-hidden border-t border-white/10 shadow-2xl">
      {/* 3D glass background with glassmorphism effect */}
          ...
          <div className="grid lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-black border border-white/20 rounded-xl flex items-center justify-center shadow-2xl">
                  <span className="text-white font-bold text-xl drop-shadow-lg">G</span>
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white font-display">Geetha Rangaseeli</h3>
                  <p className="text-white/60 text-sm">Social Media Manager & Creative Strategist</p>
                </div>
              </div>
              ...
              <div className="flex space-x-4">
                {/* Social icons, all white, with glass/3D hover effect */}
                {[
                  {
                    name: 'Twitter',
                    icon: (
                  ...
                  <a
                    key={index}
                    href="#"
                    className={`w-12 h-12 bg-black/80 border border-white/20 rounded-xl flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all duration-300 hover:scale-110 hover:shadow-2xl backdrop-blur-lg`}
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-white/60 text-sm mb-4 md:mb-0">
                © 2024 Geetha Rangaseeli. All rights reserved. Made with <span className="text-white">&#10084;&#65039;</span> for amazing brands.
              </div>
              <div className="flex items-center space-x-6 text-sm">
                ...
                <div className="flex items-center text-white/60">
                  ...
                  <span className="font-bold text-white">Available for new projects</span>
                </div>
              </div>
            </div>
          </div>
